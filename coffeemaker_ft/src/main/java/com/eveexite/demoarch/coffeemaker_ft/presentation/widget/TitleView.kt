package com.eveexite.demoarch.coffeemaker_ft.presentation.widget
...
import com.eveexite.demoarch.coffeemaker_ft.presentation.util.TitleUtils
    ...
    @JvmOverloads constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int = 0) : super(context, attrs, defStyleAttr) {
        ...
        try {
            ...
            textSize = a.getDimensionPixelSize(
                R.styleable.TitleView_textSize,
